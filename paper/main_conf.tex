...
\textbf{Step 1: Grassmannian packing.}
...
By standard volumetric arguments on the Grassmannian \citep{szarek1982nets}, for any $\delta \in (0, 1/2)$, there exists a $2\delta$-packing $\{V_1, \ldots, V_N\} \subset \mathrm{Gr}(r, d)$ such that
\begin{equation}
...
\textbf{Step 2: Instance construction.}
...
\textbf{Step 3: Pairwise KL divergence.}
...
\textbf{Step 4: Fano's inequality.}
...
\textbf{Step 6: Assumption verification.}
