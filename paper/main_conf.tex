...
\paragraph{Probe-cost lower bounds.}
  ...
  The remaining open question is whether a broader projected-exploitation class, or algorithms operating in the full $d$-dimensional ambient space, can achieve $O(\sqrt{cT})$ total regret.
