...
not~$r$.
  ...
  for projected-exploitation policies satisfying this condition---a
  class that includes SPSC and all known algorithms for this problem
...
\paragraph{Probe-cost lower bounds.}
  ...
  Hard projection onto a misaligned subspace provides the mechanism for this linear-in-$\varepsilon$ loss, and SPSC and all known algorithms for this problem satisfy the condition.
...
Hard projection onto a misaligned subspace creates an $O(\varepsilon)$ bias that provides the mechanism for the linear-in-$\varepsilon$ loss condition of Theorem~\ref{thm:probe_rate_lb}; SPSC and all known algorithms for this problem satisfy this condition.
