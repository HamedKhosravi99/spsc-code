...
Hard projection onto a misaligned subspace creates an $O(\varepsilon)$ bias that provides the mechanism for the linear-in-$\varepsilon$ loss condition of Theorem~\ref{thm:probe_rate_lb}.
