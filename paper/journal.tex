...
Algorithmically, Single-Play Subspace-Calibrated Optimism (SPSC) interleaves
probing with projected UCB exploitation in the learned $r$-dimensional subspace,
achieving costed dynamic regret
...
the projected-exploitation class $\Pi_{\mathrm{HP}}$---containing SPSC and all
