"""LinTS baselines on Pendigits. Same grid/settings as experiment_pendigits_extended.py."""
...
def make_env(seed, d, r):
    return RealPendigitsEnvironment(d=d, r=r, n_actions=40, segment_size=SEG_SIZE,
...
if __name__ == "__main__":
    ...
    print(f"Pendigits LinTS ({N_SEEDS} seeds)")
    all_results = {}
    for d in D_VALUES:
        for r in R_VALUES:
            if r >= d:
