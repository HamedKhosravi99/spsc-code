"""
Covertype Grid: d in {5, 55, 105}, r in {1, 10, 20, 30}, 10 seeds, 10 methods.
Uses Satimage winning params.
Prints per-seed per-method output.
"""
...
# ---------------------------------------------------------------------------
# Parameters (Satimage winning config)
# ---------------------------------------------------------------------------
N_SEEDS     = 10
K           = 10
T           = 5000
...
def print_cell_summary(res, d, r):
    ...
    print()
    print("=" * 110)
    print(f"  Covertype d={d}, r={r}   ({n} seeds)   lam={LAM}, pe={PROBE_EVERY}, W={WINDOW}")
    print("-" * 110)
...
if __name__ == "__main__":
    print("=" * 80)
    print("Covertype Grid (10 methods, 10 seeds)")
    print(f"  d = {D_VALUES}")
    print(f"  r = {R_VALUES}")
    print(f"  K={K}, T={T}, lam={LAM}, probe_every={PROBE_EVERY}, window={WINDOW}, c={PROBE_COST}")
    print("=" * 80)
