"""
Fashion-MNIST Grid: d in {55, 105, 200}, r in {5, 10, 20}, 3 seeds.
...
def make_env(seed, d, r):
    return FashionMNISTEnvironment(
...
def print_cell_summary(res, d, r):
    ...
    print()
    print("=" * 110)
    print(f"  Fashion-MNIST  d={d}, r={r}   ({n} seeds)   d-r={d-r}")
    print("-" * 110)
...
if __name__ == "__main__":
    print("=" * 80)
    print(f"Fashion-MNIST Grid ({len(METHOD_NAMES)} methods, {N_SEEDS} seeds)")
    print(f"  d = {D_VALUES}")
    print(f"  r = {R_VALUES}")
