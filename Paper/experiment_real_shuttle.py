"""
Experiment: Statlog Shuttle -- Real-Data-Calibrated Bandit.

Real data from UCI Shuttle (58K samples, 9 features, 7 classes).
theta_t derived from real OLS of features -> class labels.
d=45 (9 original + 36 pairwise interactions), r=2.

Compares SPSC Alg 1, LinUCB, D-LinUCB, SW-LinUCB, Oracle-LinUCB.

Outputs:
  experiment_real_shuttle.png  -- 3-panel figure
...
from real_shuttle_environment import RealShuttleEnvironment
...
if __name__ == "__main__":
    print("=" * 60)
    print("Shuttle -- Real-Data-Calibrated Bandit")
    ...
    make_figure(results, env_ref,
                os.path.join(OUT_DIR, "experiment_real_shuttle.png"), labels)
    print("Done.\n")
