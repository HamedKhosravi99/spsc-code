"""
MovieLens Fully Real Grid: d in {55, 105, 200}, r in {5, 10, 20}, 3 seeds.
Rewards = actual user ratings. Per-seed per-method timing.
"""
...
def print_cell_summary(res, d, r):
    ...
    print()
    print("=" * 110)
    print(f"  MovieLens REAL  d={d}, r={r}   ({n} seeds)   d-r={d-r}")
    print("-" * 110)
...
if __name__ == "__main__":
    print("=" * 80)
    print("MovieLens FULLY REAL Grid (10 methods, 3 seeds)")
    print(f"  d = {D_VALUES}")
    print(f"  r = {R_VALUES}")
