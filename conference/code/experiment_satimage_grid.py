"""
Satimage Grid: d in {5, 55, 105}, r in {1, 10, 20, 30}, 10 seeds, 10 methods.
Uses same winning params as extended run.
...
# ---------------------------------------------------------------------------
# Parameters (same winning config used in experiment_satimage_extended.py)
# ---------------------------------------------------------------------------
N_SEEDS     = 10
SEG_SIZE    = 500
N_SEGMENTS  = 10
...
def print_cell_summary(res, d, r):
    ...
    print()
    print("=" * 110)
    print(f"  Satimage d={d}, r={r}   ({n} seeds)   lam={LAM}, pe={PROBE_EVERY}, W={WINDOW}")
    print("-" * 110)
...
if __name__ == "__main__":
    print("=" * 80)
    print("Satimage Grid (10 methods, 10 seeds)")
    print(f"  d = {D_VALUES}")
    print(f"  r = {R_VALUES}")
