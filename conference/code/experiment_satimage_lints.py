"""LinTS baselines on Satimage. Same grid/settings as experiment_satimage_grid.py."""
...
def make_env(seed, d, r):
    return RealSatimageEnvironment(d=d, r=r, n_actions=40, segment_size=SEG_SIZE,
...
if __name__ == "__main__":
    ...
    print(f"Satimage LinTS ({N_SEEDS} seeds)")
    all_results = {}
    for d in D_VALUES:
        for r in R_VALUES:
            if r >= d:
